...
<h1 class="text-white text-center font-weight-bold bg-primary" style="font-size: 35px;"> Registration Form</h1>
	...
	<div class="container"><br>
		...
		<div class="col-lg-6 m-auto d-block">
			...
			<form action="#"  method="post" name="form-group" class="myform"  class="bg-light" onsubmit = "return validation()">
				...
				<input type="submit" name="create" value= "sign up"class="btn btn-primary"  id="submit"  onclick="onmyFunction()" autocomplete="off"></input>
			</form><br><br>
		</div>
	</div>
